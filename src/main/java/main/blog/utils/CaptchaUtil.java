...
public class CaptchaUtil{
	 ...
	 */
	public CaptchaUtil(int width,int height,int codeCount,int lineCount,int fontSize,String sessionKey)
	{
		this.width      = width;
		this.height     = height;
    ...
    public void getCode(HttpServletRequest request,HttpServletResponse response)
    {
        ...
        //4.1设置验证码字体
        g.setFont(new Font("微软雅黑", Font.BOLD|Font.ITALIC, fontSize));
